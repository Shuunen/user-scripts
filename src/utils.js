...
class Shuutils {
   ...
   * @param {'success'|'error'|'info'} type - The type of the toast notification.
   ...
   * @param {number} [delay] - The delay in milliseconds before the toast disappears. Default is 3000ms.
   * @example utils.toastInfo('hello world')
   */
  toastInfo (message, delay = 2000) { this.#toastAdd('info', message, delay) }
  /**
