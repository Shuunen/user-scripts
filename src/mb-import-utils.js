...
const insertMbForm = ({ app, title, artist, date, tracks, label, url, urlType }) => {
  ...
  tracks.forEach((track, index) => {
    ...
    addMbField(form, `mediums.0.track.${index}.length`, track.length, true)
  })
  ...
  addMbField(form, 'edit_note', 'Release added using github.com/Shuunen/user-scripts/src/mb-import-from-amazon-music.user.js', true)
  addMbSubmit(form)
